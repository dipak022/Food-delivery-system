...
@section('content')
	...
	<div class="wthree-order">  
		<img src="{{asset('frontend/')}}/images/i2.jpg" class="w3order-img" alt=""/>
		<div class="container">
			...
			<div class="spldishes-agileinfo">
				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="{{asset('frontend/')}}/images/g2.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="{{asset('frontend/')}}/images/g3.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="{{asset('frontend/')}}/images/g4.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="{{asset('frontend/')}}/images/g5.jpg" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="{{asset('frontend/')}}/images/g1.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
